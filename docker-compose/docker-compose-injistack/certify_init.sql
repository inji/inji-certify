...
VALUES (
    ...
    'https://inji.github.io/inji-config/contexts/farmer.json,https://www.w3.org/2018/credentials/v1',  -- context as comma-separated string (must be alphabetically sorted to match request-side lookup key)
